 ...
 */
public class InitializrDefaultStarterBuildCustomizer implements BuildCustomizer<Build> {

	private final InitializrMetadata metadata;

	public InitializrDefaultStarterBuildCustomizer(InitializrMetadata metadata) {
